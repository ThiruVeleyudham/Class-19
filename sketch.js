var trex, trex_running, trex_collided, restart, restartImage, GO, GOImage;
...
function setup() {
  ...
  restart.addImage("fjhfjf", restartImage);
  restart.visible = false
  restart.scale = 0.7;

  GO = createSprite(300,80,10,10);
  GO.addImage("ghgfj", GOImage);
  GO.visible= false;
  GO.scale = 0.9;
